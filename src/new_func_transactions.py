...
def read_csv_transactions(file_name: str) -> list[dict]:
    """Функция, которая считывает данные из файла CSV и преобразует в список словарей"""
...
def read_xlsx_transactions(file_name: str) -> list[dict]:
    """Функция, которая считывает данные из файла XLSX и преобразует в список словарей"""
