...
from src.xlsx_dict import get_xlsx_dict
...
def get_transactions(user_input):
    """Выбирает нужный путь к файлу в выбранном формате"""
    if user_input == "1":
        transactions = get_transactions_dictionary("../data/operations.json")
        return transactions
    elif user_input == "2":
        transactions = get_csv_dict("../data/transactions.csv")
        return transactions
    elif user_input == "3":
        transactions = get_xlsx_dict("../data/transactions_excel.xlsx")
        return transactions
...
def get_transactions_list_by_date(transactions, user_input, user_input_sort):
...
def get_transactions_list_RUB(transactions, user_input):
    new_transactions = []
    if user_input.lower() == "да":
...
def get_transactions_list_by_word(transactions, user_input, word):
